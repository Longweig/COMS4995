...
[![Build Status](https://travis-ci.org/Longweig/FreeFree.svg?branch=master)](https://travis-ci.org/Longweig/FreeFree) ![GitHub last commit](https://img.shields.io/github/last-commit/Longweig/FreeFree)
### Motivations
