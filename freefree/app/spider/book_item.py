...
class Book:
    ...
    def search_by_keyword(self, q, page=1):
        """Get formatted HTTP response by keyword `q` and specified page number `page`
    ...
    def search_by_isbn(self, isbn):
        ...
        :param isbn: The unique ID number in specific format
        of books used for search.
        :type isbn: string"""
    ...
    def calculate_start(page):
        ...
        Calculate the `start` index of the API function parameter
